...
<html lang="en-US">
	...
	<title>Log In &lsaquo; doctor &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to doctor</a>		</p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/doctor\/wp-admin\/admin-ajax.php"}};
</script>
<script src="./wp-includes/js/wp-util.min.js?ver=5.8" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"f4ea9a48a0"};
</script>
